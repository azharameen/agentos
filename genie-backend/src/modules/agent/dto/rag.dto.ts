...
export class AddDocumentsDto {
  ...
  @ArrayMaxSize(100, {
    message: "Cannot add more than 100 documents at once",
  })
  @IsString({ each: true })
  ...
  @IsArray()
  @ArrayMaxSize(100, {
    message: "Metadata array must not exceed 100 items",
  })
...
export class RagQueryDto {
  ...
  @MaxLength(5000, { message: "Query must not exceed 5000 characters" })
  @IsSanitized()
  query: string;
  ...
  @Max(10, { message: "topK must not exceed 10" })
  topK?: number;
  ...
  @IsOptional()
  @IsNumber()
  @Min(0, { message: "minScore must be at least 0" })
  @Max(1, { message: "minScore must not exceed 1" })
  minScore?: number;
}
